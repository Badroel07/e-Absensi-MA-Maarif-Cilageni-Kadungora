        ...
        <div class="w-full bg-gradient-to-r from-emerald-800 via-maarif-700 to-emerald-800 border-t border-emerald-900/80 shadow-[0_-4px_24px_rgba(0,0,0,0.25)] px-3 pt-2 safe-bottom pointer-events-auto">
            @if(Auth::user()->role === 'siswa')
                <div class="grid grid-cols-4 items-center max-w-md mx-auto">
                    <!-- 1. Dashboard -->
                    <a href="{{ route('siswa.dashboard') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('siswa.dashboard') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('siswa.dashboard') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Dashboard</span>
                    </a>

                    <!-- 2. Jadwal -->
                    <a href="{{ route('siswa.schedule') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('siswa.schedule') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('siswa.schedule') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Jadwal</span>
                    </a>

                    <!-- 3. Riwayat -->
                    <a href="{{ route('siswa.history') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('siswa.history') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('siswa.history') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Riwayat</span>
                    </a>

                    <!-- 4. Profil -->
                    <a href="{{ route('profile') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('profile') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('profile') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Profil</span>
                    </a>
                </div>
            @elseif(Auth::user()->role === 'guru')
                <div class="grid grid-cols-5 items-center max-w-md mx-auto">
                    <!-- 1. Dashboard -->
                    <a href="{{ route('guru.dashboard') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('guru.dashboard') && !request()->has('jadwal') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('guru.dashboard') && !request()->has('jadwal') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Dashboard</span>
                    </a>

                    <!-- 2. Jadwal Mengajar -->
                    <a href="{{ route('guru.schedule') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('guru.schedule') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('guru.schedule') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Jadwal</span>
                    </a>
                    ...
                    <a href="{{ route('guru.scan') }}" class="group relative flex flex-col items-center justify-center -mt-6">
                        ...
                        <span class="text-[10px] font-bold mt-1 tracking-tight {{ request()->routeIs('guru.scan') ? 'text-amber-300' : 'text-emerald-200/80 group-hover:text-white' }}">Pindai QR</span>
                    </a>

                    <!-- 4. Riwayat -->
                    <a href="{{ route('guru.history') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('guru.history') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('guru.history') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Riwayat</span>
                    </a>
            ...
            @elseif(Auth::user()->role === 'admin')
                <div class="grid grid-cols-4 items-center max-w-md mx-auto">
                    <!-- 1. Dashboard Admin -->
                    <a href="{{ route('admin.dashboard') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('admin.dashboard') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('admin.dashboard') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Dashboard</span>
                    </a>

                    <!-- 2. Siswa -->
                    <a href="{{ route('admin.siswa.index') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('admin.siswa.*') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('admin.siswa.*') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Siswa</span>
                    </a>

                    <!-- 3. Guru -->
                    <a href="{{ route('admin.guru.index') }}" class="group flex flex-col items-center justify-center py-1 transition-all duration-150 {{ request()->routeIs('admin.guru.*') ? 'text-white font-extrabold' : 'text-emerald-200/75 hover:text-white font-medium' }}">
                        ...
                        <span class="text-[10px] tracking-tight mt-0.5 {{ request()->routeIs('admin.guru.*') ? 'text-white font-bold' : 'text-emerald-200/75 group-hover:text-white' }}">Guru</span>
                    </a>
