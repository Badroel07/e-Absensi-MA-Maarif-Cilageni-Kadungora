...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-3xl border border-slate-200/80 p-4 sm:p-5 shadow-xs space-y-4">
        ...
        <form method="GET" action="{{ route('siswa.history') }}" data-loading-form class="grid grid-cols-1 sm:grid-cols-12 sm:items-end gap-3 pt-2 border-t border-slate-100 text-xs">
            @if($selectedStatus)
            ...
            <div class="sm:col-span-3 flex flex-col gap-1">
                ...
                <div class="relative w-full pl-4 pr-10 py-2.5 rounded-xl border border-slate-200 bg-slate-50/70 text-xs transition focus-within:bg-white focus-within:ring-2 focus-within:ring-emerald-600 flex items-center min-h-[42px] cursor-pointer" data-date-wrap>
